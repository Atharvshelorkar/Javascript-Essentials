...
let user1 = new user('Atharv',20,'atharv@gmail.com')
let user2 = new user('Jay',21,'jay@gmail.com')
let mod = new Moderator('Ananny',20, 'aj@gmail.com','Moderator');
let admin = new Admin('Jaydeep',20,'jaydeep@gmail.com');
